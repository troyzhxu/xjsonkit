...
```groovy
implementation 'com.ejlchina:jsonkit-core:1.2.1'
```

使用 Jackson 底层实现：

```groovy
implementation 'com.ejlchina:jsonkit-jackson:1.2.1'
```

使用 Gson 底层实现：

```groovy
implementation 'com.ejlchina:jsonkit-gson:1.2.1'
```

使用 Fastjson 底层实现：

```groovy
implementation 'com.ejlchina:jsonkit-fastjson:1.2.1'
```
